        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              <li>
                <a 
                  href="https://github.com/LimaDevBTC/DogData-v1" 
                  target="_blank" 
                ...
                >
                  ...
                  <div className="flex-1">
                    <span className="font-mono text-sm font-medium tracking-wide block">SOURCE CODE</span>
                    <span className="text-xs text-gray-500 font-mono">GitHub Repository</span>
                  </div>
