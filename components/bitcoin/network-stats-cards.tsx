    ...
    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2.5 md:gap-6">
      ...
      <Card variant="glass" className="border-yellow-500/20 hover:border-yellow-500/40 transition-all">
        <CardHeader className="pb-2">
          <CardTitle className="text-yellow-400 text-sm md:text-lg flex items-center">
            <DollarSign className="w-3.5 h-3.5 md:w-5 md:h-5 mr-1.5 md:mr-2" />
            Bitcoin Price
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card variant="glass" className="border-orange-500/20 hover:border-orange-500/40 transition-all">
        <CardHeader className="pb-2">
          <CardTitle className="text-orange-400 text-sm md:text-lg flex items-center">
            <Shield className="w-3.5 h-3.5 md:w-5 md:h-5 mr-1.5 md:mr-2" />
            Block Height
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card variant="glass" className="border-green-500/20 hover:border-green-500/40 transition-all">
        <CardHeader className="pb-2">
          <CardTitle className="text-green-400 text-sm md:text-lg flex items-center">
            <Zap className="w-3.5 h-3.5 md:w-5 md:h-5 mr-1.5 md:mr-2" />
            Hash Rate
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card variant="glass" className="border-blue-500/20 hover:border-blue-500/40 transition-all">
        <CardHeader className="pb-2">
          <CardTitle className="text-blue-400 text-sm md:text-lg flex items-center">
            <Activity className="w-3.5 h-3.5 md:w-5 md:h-5 mr-1.5 md:mr-2" />
            Mempool
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card variant="glass" className="border-purple-500/20 hover:border-purple-500/40 transition-all">
        <CardHeader className="pb-2">
          <CardTitle className="text-purple-400 text-sm md:text-lg flex items-center">
            <Hash className="w-3.5 h-3.5 md:w-5 md:h-5 mr-1.5 md:mr-2" />
            Difficulty
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card variant="glass" className="border-cyan-500/20 hover:border-cyan-500/40 transition-all">
        <CardHeader className="pb-2">
          <CardTitle className="text-cyan-400 text-sm md:text-lg flex items-center">
            <Clock className="w-3.5 h-3.5 md:w-5 md:h-5 mr-1.5 md:mr-2" />
            Avg Block Time
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card variant="glass" className="border-red-500/20 hover:border-red-500/40 transition-all">
        <CardHeader className="pb-2">
          <CardTitle className="text-red-400 text-sm md:text-lg flex items-center">
            <Activity className="w-3.5 h-3.5 md:w-5 md:h-5 mr-1.5 md:mr-2" />
            Network Fee
          </CardTitle>
        </CardHeader>
      ...
      <Card variant="glass" className="border-emerald-500/20 hover:border-emerald-500/40 transition-all">
        <CardHeader className="pb-2">
          <CardTitle className="text-emerald-400 text-sm md:text-lg flex items-center">
            <Shield className="w-3.5 h-3.5 md:w-5 md:h-5 mr-1.5 md:mr-2" />
            Network Health
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-between">
            <div className="text-base md:text-2xl font-bold text-white font-mono">
