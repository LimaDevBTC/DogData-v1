#!/usr/bin/env python3
"""
Script para forçar atualização dos dados de holders
"""
...
def main():
    print("🔄 Forçando atualização dos dados de holders...")
    print("=" * 50)
    ...
    print("=" * 50)
    print("✅ Dados de holders atualizados com sucesso!")
