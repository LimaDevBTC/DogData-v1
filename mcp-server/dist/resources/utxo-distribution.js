...
export function registerUtxoDistributionResource(server) {
    server.resource("utxo-distribution", "dog://utxo-distribution", async (uri) => {
...
//# sourceMappingURL=utxo-distribution.js.map