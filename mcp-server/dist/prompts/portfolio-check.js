import { z } from "zod";
export function registerPortfolioCheckPrompt(server) {
    server.prompt("portfolio-check", "Check a Bitcoin address to see their DOG holdings, value, rank among holders, " +
...
//# sourceMappingURL=portfolio-check.js.map