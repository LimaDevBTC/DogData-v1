...
export default function HoldersPage() {
  ...
  const [solanaHolders, setSolanaHolders] = useState<number>(10966) // Hardcoded
  const [stacksHolders, setStacksHolders] = useState<number>(579) // Hardcoded - atualizado a cada hora pelo script (external_holders.json)
